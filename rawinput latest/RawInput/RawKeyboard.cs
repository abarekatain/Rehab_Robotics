...
namespace RawInput_dll
{
	public sealed class RawKeyboard
	{
		...
		public void ProcessRawInput(IntPtr hdevice)
		{
           ...
           // Debug.WriteLine(_rawBuffer.data.mouse.lLastX);
   ...
   //             }
            ...
            keyPressEvent.DeviceName = _rawBuffer.header.hDevice.ToString();
            keyPressEvent.LastX = _rawBuffer.data.mouse.lLastX;
            keyPressEvent.LastY = _rawBuffer.data.mouse.lLastY;
